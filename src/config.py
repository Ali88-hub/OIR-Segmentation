...
class Config:
    ...
    tversky_alpha: Tuple[float, ...] = (0.35, 0.3, 0.5)  # FP penalty per class (NV raised from 0.2 to reduce vessel FPs)
    ...
    nv_max_eccentricity: float = 1.0    # disabled — NV is biologically elongated, eccentricity filter kills recall
